...
New_Pheno_long_t1 <- New_Pheno_long_t1 %>%                                            # Adding standardizing the phenotypes, as to not give too high importance of later measurements                                                                                                                                                                                                               
...
New_Pheno_long_t2 <- New_Pheno_long_t2 %>%                                            # Adding standardizing the phenotypes, as to not give too high importance of later measurements                                                                                                                                                                                                               
  mutate(Pheno_std = scale(Pheno_Inb)) %>%                                     # even if there could be an argument for keeping it that way, as the older tree is closer              
  ungroup()  
...
# between traits. Now they are assumed to be independent, which is very not true
