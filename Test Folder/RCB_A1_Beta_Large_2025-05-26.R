...
# Reorder based on the rownames of K
New_Pheno_mean <- New_Pheno_mean[match((G4_pop@id), New_Pheno_mean$ID), ]

A_Mat_s <- A_Mat[G4_pop@id, G4_pop@id]

# Estimate inbreeding from A-matrix
Inb <- as.data.frame(diag(A_Mat_s)-1)

# Match the order of the pop object
Inb <- Inb[match(rownames(Inb), G4_pop@id), ]
...
# Reorder based on the rownames of K
New_Pheno_mean <- New_Pheno_mean[match((G5_pop@id), New_Pheno_mean$ID), ]

A_Mat_s <- A_Mat[G5_pop@id, G5_pop@id]

# Estimate inbreeding from A-matrix
Inb <- as.data.frame(diag(A_Mat_s)-1)

# Match the order of the pop object
Inb <- Inb[match(rownames(Inb), G5_pop@id), ]
...
# Reorder based on the rownames of K
New_Pheno_mean <- New_Pheno_mean[match((G6_pop@id), New_Pheno_mean$ID), ]

A_Mat_s <- A_Mat[G6_pop@id, G6_pop@id]

# Estimate inbreeding from A-matrix
Inb <- as.data.frame(diag(A_Mat_s)-1)

# Match the order of the pop object
Inb <- Inb[match(rownames(Inb), G6_pop@id), ]
...
# Diversity metrics
indices<-which((rownames(A_Mat) %in% G6_pop@id))
A_Mat <-A_Mat[indices,indices]
n <- nrow(A_Mat)
...
# Reorder based on the rownames of K
New_Pheno_mean <- New_Pheno_mean[match((G7_pop@id), New_Pheno_mean$ID), ]

A_Mat_s <- A_Mat[G7_pop@id, G7_pop@id]

# Estimate inbreeding from A-matrix
Inb <- as.data.frame(diag(A_Mat_s)-1)

# Match the order of the pop object
Inb <- Inb[match(rownames(Inb), G7_pop@id), ]
...
# Diversity metrics
indices<-which((rownames(A_Mat) %in% G7_pop@id))
A_Mat <-A_Mat[indices,indices]
n <- nrow(A_Mat)
...
# Reorder based on the rownames of K
New_Pheno_mean <- New_Pheno_mean[match((G8_pop@id), New_Pheno_mean$ID), ]

A_Mat_s <- A_Mat[G8_pop@id, G8_pop@id]

# Estimate inbreeding from A-matrix
Inb <- as.data.frame(diag(A_Mat_s)-1)

# Match the order of the pop object
Inb <- Inb[match(rownames(Inb), G8_pop@id), ]
...
# Diversity metrics
indices<-which((rownames(A_Mat) %in% G8_pop@id))
A_Mat <-A_Mat[indices,indices]
n <- nrow(A_Mat)
...
# Reorder based on the rownames of K
New_Pheno_mean <- New_Pheno_mean[match((G9_pop@id), New_Pheno_mean$ID), ]

A_Mat_s <- A_Mat[G9_pop@id, G9_pop@id]

# Estimate inbreeding from A-matrix
Inb <- as.data.frame(diag(A_Mat_s)-1)

# Match the order of the pop object
Inb <- Inb[match(rownames(Inb), G9_pop@id), ]
...
# Diversity metrics
indices<-which((rownames(A_Mat) %in% G9_pop@id))
A_Mat <-A_Mat[indices,indices]
n <- nrow(A_Mat)
...
# Reorder based on the rownames of K
New_Pheno_mean <- New_Pheno_mean[match((G10_pop@id), New_Pheno_mean$ID), ]

A_Mat_s <- A_Mat[G10_pop@id, G10_pop@id]

# Estimate inbreeding from A-matrix
Inb <- as.data.frame(diag(A_Mat_s)-1)

# Match the order of the pop object
Inb <- Inb[match(rownames(Inb), G10_pop@id), ]
...
# Diversity metrics
indices<-which((rownames(A_Mat) %in% G10_pop@id))
A_Mat <-A_Mat[indices,indices]
n <- nrow(A_Mat)
